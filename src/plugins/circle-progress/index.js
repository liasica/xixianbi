...
export const CircleProgress = (function () {
    /**
     * Utility functions
     * @type {Object}
     */
    ...
    class CircleProgress {
        ...
        constructor (el, opts = {}, doc = document) {
            ...
            this.graph.sector = this.graph.paper
                .path(
                    CircleProgress._makeSectorPath(
                        50,
                        50,
                        50 - circleThickness / 2,
                        0,
                        0
                    )
                )
        ...
        attr (attrs) {
            if (typeof attrs === 'string') {
                ...
                throw new TypeError(
                    `Wrong argument passed to attr. Expected object, got "${typeof attrs}"`
                )
            }
        ...
        _set (key, val) {
            ...
            if (val === undefined) {
                throw new TypeError(
                    `Failed to set the ${key} property on CircleProgress: The provided value is non-finite.`
                )
            }
            ...
            if (
                ['min', 'max', 'constrain'].indexOf(key) !== -1 &&
        ...
        _updateGraph () {
            ...
            if (typeof this.textFormat === 'function') {
                ...
                this.graph.textMax.el.textContent =
                    this.max !== undefined ? this.max : this.indeterminateText
            }
        }
